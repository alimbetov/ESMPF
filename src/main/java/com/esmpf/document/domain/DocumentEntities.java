...
class ReportTemplate extends TenantEntity {
    ...
    @Column(name = "template_content", nullable = false, columnDefinition = "text") private String templateContent;
    @Column(name = "stylesheet_content", columnDefinition = "text") private String stylesheetContent;
...
class GeneratedDocument extends TenantEntity {
    ...
    @JdbcTypeCode(SqlTypes.JSON) @Column(name = "delivery_data_json", columnDefinition = "jsonb") private String deliveryDataJson;
}
...
class DocumentSignature extends TenantEntity {
    ...
    @JdbcTypeCode(SqlTypes.JSON) @Column(name = "verification_data_json", columnDefinition = "jsonb") private String verificationDataJson;
}
