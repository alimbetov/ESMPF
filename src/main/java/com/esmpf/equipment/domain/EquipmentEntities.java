...
class Equipment extends BaseEntity {
    ...
    @Column(name = "asset_number") private String assetNumber;
...
class EquipmentRelation extends BaseEntity {
    @Column(name = "source_equipment_id") private UUID sourceEquipmentId;
    @Column(name = "target_equipment_id") private UUID targetEquipmentId;
...
class EquipmentIssue extends BaseEntity {
...
class MeterReading extends BaseEntity {
    @Column(name = "equipment_id") private UUID equipmentId;
    @Column(name = "meter_code") private String meterCode;
    @Column(name = "reading_value") private BigDecimal readingValue;
